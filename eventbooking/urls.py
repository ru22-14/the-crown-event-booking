...
urlpatterns = [
    ...
    path('booking/', login_required(views.EventBookingView.as_view()), name='booking'),
    path('mybooking/', login_required(views.MyBookingView.as_view()), name='mybooking'),
    path('update_booking/<int:booking_id>/', login_required(views.UpdateBookingView.as_view()), name='update_booking'),
